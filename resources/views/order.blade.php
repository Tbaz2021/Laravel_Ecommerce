      ...
      <div class="center_prod_box_big">
        <div class="contact_form" >
         ...
         <div style="text-align: center" class="mb-5">
           ...
           <p>Manufacturer:<span class="text-info">{{ $product->brand->name }}</span></p>
        ...
        @endif</span></p>
         ...
         <hr>
   <h6>Order Now</h6>
   <p><span class="text-info">Notice:</span> Delivery Team only work within Lagos... <span class="btn-success">$10</span>Delivery Charge</p>
